...
export const sendEmailWithAttachment = async (filePath, subscriptionName) => {
  ...
  const mailOptions = {
    ...
    subject: `Informe Mensual de Recursos Azure - ${month} ${year}`,
    ...
    html: `
        ...
        <p>Te enviamos el reporte de costos de las suscripciones: <strong>${subscriptionName}</strong> correspondiente al periodo <strong>${month} ${year}</strong>.</p>
